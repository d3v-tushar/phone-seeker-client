...
const Stats = () => {
  return (
    <>
    <h2 className="text-4xl text-center font-semibold mt-8 text-gray-600">Our Statistics</h2>
    <section className="p-6 my-6 dark:bg-gray-800 dark:text-gray-100 rounded-xl">
